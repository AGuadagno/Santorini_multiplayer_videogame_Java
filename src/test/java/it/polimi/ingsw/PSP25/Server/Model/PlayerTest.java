package it.polimi.ingsw.PSP25.Server.Model;

import it.polimi.ingsw.PSP25.Server.Model.GodPowers.Athena;
...
public class PlayerTest {
    ...
    @Before
    public void setup() {
        player = new Player("Demo", 1, new ClientHandler(new Socket(), 1, new Lobby()));
    }
    ...
    public void getClientHandler() {
        ...
        ClientHandler cl = new ClientHandler(new Socket(), 1, new Lobby());
        Player player2 = new Player("Demo", 1, cl);

        assertEquals(cl, player2.getClientHandler());
    }
}
