...
import it.polimi.ingsw.PSP25.Server.ControllerObserver;
 ...
 */
public class GodPower implements ControllerObserver {
    ...
    protected boolean askToMoveWorker(Player player, List<Space> validMovementSpacesW1,
        ...
        player.getClientHandler().askWorkerMovement(playerName,
        ...
        int[] workerAndSpace = player.getController().updateAskWorkerMovement();
