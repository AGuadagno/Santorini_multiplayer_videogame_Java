...
public class Player {
    ...
    private ModelObserver clientHandler;
    private ControllerObservable controller;
    ...
    public Player(String name, int playerNumber, ClientHandler clientHandler) {
        ...
        this.controller = new Controller(this, clientHandler);
    }
     ...
     */
    public ModelObserver getClientHandler() {
        return clientHandler;
    }

    public ControllerObservable getController() {
        return controller;
    }
}